...
const loadImage = () => {
  ...
  previewImg.src = URL.createObjectURL(file); // passing file url as previewing img src
...
rotateOptions.forEach(option => {
    option.addEventListener("click", () => { // adding click event listener to all rotate/flip buttons
        if(option.id === "left") {
            ...
            rotate += 90;  // if clicked button is right rotate, incriment rotate value by -9
